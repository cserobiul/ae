        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            ...
            <tbody>
                 ...
                 <tr>
                    ...
                    <td class="text-center border-b">{{ ucwords($user->name) }}</td>
                    <td class="text-center border-b">{{ $user->email }}</td>
                    <td class="text-center border-b">{{ ucwords($user->phone) }}</td>
                    ...
                    <td class="border-b w-5">
                        <div class="flex sm:justify-center items-center">
                            @canany(['user.update'])
                                <a href="{{ route('users.edit',$user->id) }}" class="flex items-center mr-3">
